...
VALUES (
    ...
    (
        ...
        29.50,
        'https://images.unsplash.com/photo-1477617722074-45613a51bf6d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        'Sushi Combo',
        79.90,
    ...
    (
        'Lasagna à Bolonhesa',
        39.99,
        'https://images.unsplash.com/photo-1621510456681-2330135e5871?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        'Torta de Chocolate',
        22.75,
        'https://images.unsplash.com/photo-1627394728092-d080498ae85d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    );